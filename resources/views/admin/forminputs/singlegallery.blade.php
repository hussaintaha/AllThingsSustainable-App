   ...
   <div role="group" class="Polaris-FormLayout--grouped">
      <div class="Polaris-FormLayout__Items">
         <div class="Polaris-FormLayout__Item">
            <div class="">
               <div class="Polaris-Labelled__LabelWrapperthumbGallaryPath">
                  <div class="Polaris-Label" style="width:100%;">
                     <label id="banner-heading1Label" for="banner-heading1" class="Polaris-Label__Text">
                        Banner Heading
               ...
               <div class="Polaris-Connected">
                  <div class="Polaris-Connected__Item Polaris-Connected__Item--primary">
                     <div class="Polaris-TextField">
                        <input name="banner_heading[]" value="{{$banner['heading']}}" id="banner-heading1" placeholder="Banner Heading{{$bk+1}}" class="Polaris-TextField__Input" type="text">
         ...
         <div class="Polaris-FormLayout__Item">
            <div class="">
               <div class="Polaris-Labelled__LabelWrapper">
                  <div class="Polaris-Label" style="width:100%;">
                    <label id="banner-para{{$bk}}Label" for="banner-para{{$bk+1}}" class="Polaris-Label__Text">Banner Description</label>
                  </div>
               </div>
               <div class="Polaris-Connected">
                  <div class="Polaris-Connected__Item Polaris-Connected__Item--primary">
                     <div class="Polaris-TextField">
                        <textarea name="banner_para[]" id="banner-para{{$bk}}" placeholder="Banner para{{$bk+1}}" class="Polaris-TextField__Input" aria-invalid="false" aria-multiline="true">{{$banner['para']}}</textarea>
                        <div class="Polaris-TextField__Backdrop"></div>
                     </div>
                  </div>
               </div>
      ...
      <div class="Polaris-FormLayout__Items">
         <div class="Polaris-FormLayout__Item" style="margin-bottom:2%">
            <div class="">
               <div class="Polaris-Labelled__LabelWrapper">
                  <div class="Polaris-Label" style="width:100%">
                    <label for="gallery_file{{$bk}}" class="Polaris-Label__Text">
                      Gallery file
                      <span class="info-img">Image files accepted of 1443X450 px</span></label></div>
               </div>
               <div class="Polaris-Connected">
                 <input class="main-gallery gal" data-file-name="thumb_gallery_file" data-field-name="gallery{{$bk}}" accept="image/x-png,image/gif,image/jpeg" id="gallery_file{{$bk}}" type="file">
               </div>
            </div>
            <img class="upload-preview display-block" style="float: right;margin-top: -28px;" src="{{$banner['slider_image']}}">
         </div>
         <input type="hidden"  name="banner_images[]" value="{{$banner['slider_image']}}" class="imggallery_file{{$bk}}">
      </div>
   </div>
</div>
