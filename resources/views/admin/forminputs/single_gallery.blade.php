            ...
            <div class="">
               <div class="Polaris-Labelled__LabelWrapper">
                  <div class="Polaris-Label" style="width:100%">
                     <label for="{{$file_id}}" class="Polaris-Label__Text">
                        Gallery file <span class="info-img">Image files accepted</span>
               ...
               <div class="Polaris-Connected">
                  <input class="main-gallery gal" data-file-name="{{$data_file_name}}" data-field-name="{{$data_field_name}}" accept="image/x-png,image/gif,image/jpeg" id="{{$file_id}}" type="file">
               </div>
            </div>
            <img class="upload-preview" style="float: right;margin-top: -28px;display:block" src="{{$path}}">
         </div>
         <input type="hidden" name="{{$data_txb_name}}[]" value="{{$path}}" class="img{{$data_field_name}}">
      </div>
   </div>
</div>
