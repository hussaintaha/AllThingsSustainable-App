                     ...
                     <div class="cards-container" d style="position: relative; z-index: 1;">
                        <div class="Polaris-Card">
                           <div class="Polaris-Card__Section">
                              ...
                              <div class="Polaris-FormLayout">
                                 @include('admin.forminputs.features', array('settings' => $settings,'setting_name'=>'Settings','input_name'=>'settings'))
                                 @include('admin.forminputs.features', array('settings' => $caps,'setting_name'=>'Capacity','input_name'=>'capacity'))
                                 @include('admin.forminputs.features', array('settings' => $prices,'setting_name'=>'Pricing','input_name'=>'prices'))
                                 @include('admin.forminputs.features', array('settings' => $amenities,'setting_name'=>'Amenities','input_name'=>'amenities'))
                              </div>
                           </div>
                        </div>
                     </div>
