                           ...
                           <div class="Polaris-FormLayout">
                                               ...
                                               <div class="Polaris-TextField">
                                                  <select  name="country" id="country" required class="NewSelector">
                                                     ...
                                                     @foreach ($countries as $country)
                                                       <option value="{{$country->name}}" <?php
                                                       if($details->country == $country->name){
                                                         echo "selected";
                                                       }
                                                       ?>  data-country_id="{{$country->id}}">{{$country->name}}</option>
                                                     @endforeach
                                                  </select>
                              ...
                              <div role="group" class="Polaris-FormLayout--grouped">
                                 <div class="Polaris-FormLayout__Items">
                                    ...
                                    @include('admin.forminputs.textfields', array('label_name' => 'USP Number 1','input_name'=>'usp_number_1','value'=> $details->usp_1))
                                 </div>
                              </div>
                              <div role="group" class="Polaris-FormLayout--grouped">
                                 <div class="Polaris-FormLayout__Items">
                                    @include('admin.forminputs.textfields', array('label_name' => 'USP Number 2','input_name'=>'usp_number_2','value'=> $details->usp_2))
                                    @include('admin.forminputs.textfields', array('label_name' => 'USP Number 2','input_name'=>'usp_number_3','value'=> $details->usp_3))
                                 </div>
                              </div>
                           </div>
                        </div>
