      ...
      <form class="vendorform">
         <div class="Polaris-Layout">
               ...
               <div class="Polaris-Layout__AnnotationWrapper">
                  ...
                  <div class="Polaris-Layout__AnnotationContent">
                     <div class="cards-container" style="position: relative; z-index: 1;">
                        <div class="Polaris-Card">
                           <div class="Polaris-Card__Section">
                            <div id="myBar" class="myBar"></div><span id="perCount"></span>
                              <div class="Polaris-Card__SectionHeader">
                              </div>
                              <div class="Polaris-FormLayout">
                                 <div role="group" class="Polaris-FormLayout--grouped">
                                   ...
                                   <input type="hidden" id="avtar_image_path" name="avtar_image_path">
                                  <span id="perCount"></span>
                                  <img id="uploadPreview1" style="border:none;">
                                   ...
                                   <input type="hidden" id="feature_image1_path" name="feature_image_path1">
                                   <img id="uploadPreview2" style="border:none;">
                                  ...
                                  <script>
                                   ...
                                   $(".myBar").attr("id", "myBar");
                                    var fileInput = document.getElementById('avtar_image');
                                      ...
                                      xhr: function() {
                                         ...
                                         xhr.upload.addEventListener("progress", function(evt) {
                                          ...
                                          console.log('progress '+percentComplete);
                                            ...
                                            $('#perCount').html(elem.style.width = width + "%");
                                         ...
                                         success:function(response){
                                          ...
                                          $("#uploadPreview1").css("height", "100px");
                                          $('#uploadPreview1').attr('src',imgpath);
                                          $('#avtar_image_path').val(imgpath);
                                          setTimeout(function(){
                                                  clearInterval(width);
                                          }, 1000);
                                          }
                                 ...
                                 <script>
                                   $( "#feature_image1" ).change(function() {
                                    $(".myBar").attr("id", "myBar");
                                    var fileInput = document.getElementById('feature_image1');
                                    var file = fileInput.files[0];
                                    var formData = new FormData();
                                    formData.append('feature_image1', file);
                                    $.ajax({
                                      xhr: function() {
                                      var xhr = new window.XMLHttpRequest();
                                         ...
                                         success:function(response){
                                          ...
                                          if(response.result==1){
                                          var imgpath = response.path;
                                          $("#uploadPreview2").css("height", "100px");
                                          $('#uploadPreview2').attr('src',imgpath);
                                          $('#feature_image1_path').val(imgpath);
                                 ...
                                 <div role="group" class="Polaris-FormLayout--grouped">
                                   ...
                                   <input type="hidden" id="feature_image2_path" name="feature_image_path2">
                                   <div id='imagLdr3'>
                                    </div> 
                                   <img id="uploadPreview3" style="border:none;">
                                   <script>
                                   $( "#feature_image2" ).change(function() {
                                    var fileInput = document.getElementById('feature_image2');
                                    var file = fileInput.files[0];
                                    var formData = new FormData();
                                    formData.append('feature_image2', file);
                                    $.ajax({
                                      xhr: function() {
                                          var xhr = new window.XMLHttpRequest();
                                         ...
                                         success:function(response){
                                          ...
                                          if(response.result==1){
                                          var imgpath = response.path;
                                          $("#uploadPreview3").css("height", "100px");
                                          $('#uploadPreview3').attr('src',imgpath);
                                          $('#feature_image2_path').val(imgpath);
                                          setTimeout(function(){
                                                  clearInterval(ids);
                                          }, 1000);
                                          }
                                   ...
                                   <input type="hidden" id="feature_image3_path" name="feature_image_path3">
                                   <div id='imagLdr4'>
                                    </div> 
                                   <img id="uploadPreview4" style="border:none;">
                                   <script>
                                   $( "#feature_image3" ).change(function() {
                                    var fileInput = document.getElementById('feature_image3');
                                    var file = fileInput.files[0];
                                    var formData = new FormData();
                                    formData.append('feature_image3', file);
                                    $.ajax({
                                      xhr: function() {
                                          var xhr = new window.XMLHttpRequest();
                                         ...
                                         success:function(response){
                                          ...
                                          $("#uploadPreview4").css("height", "100px");
                                          $('#uploadPreview4').attr('src',imgpath);
                                          $('#feature_image3_path').val(imgpath);
                                          }
                                         }
                                       })
                                    });
            ...
            @include('admin.forminputs.gallery', [
              ...
              'form_details'=>'Add Contents for Vendor Thumbnail Gallary viewble on vendor profile page',
...
*/
  function thumbPreviewImage(id){

    var fileInput = document.getElementById('gallery_file'+id);
      var file = fileInput.files[0];
      var formData = new FormData();
      formData.append('thumb_gallery_file', file);
      $.ajax({
        xhr: function() {
        var xhr = new window.XMLHttpRequest();
       ...
       xhr.upload.addEventListener("progress", function(evt) {
        ...
        percentComplete = parseInt(percentComplete * 100);
        console.log('progress '+percentComplete);
          var elem = document.getElementById("myBarbulk1");
          var width = percentComplete;
          $('#perCount'+id).html(elem.style.width = width + "%");
        if (percentComplete === 100) {
            }
           }
          }, false);
          ...
          return xhr;
           ...
           success:function(response){
            ...
            var imgpath = response.path;
            console.log(imgpath);
            $("#thumbPreview"+id).css("height", "100px");
            $('#thumbPreview'+id).attr('src',imgpath);
            $('#thumbGallaryPath'+id).val(imgpath);
            }
           }
         });
  }
...
function gallaryPreviewImage(id){

    var fileInput = document.getElementById('gallery_file_snd'+id);
      var file = fileInput.files[0];
      var formData = new FormData();
      formData.append('thumb_gallery_file', file);
      $.ajax({
           ...
           success:function(response){
            ...
            if(response.result==1){
            var imgpath = response.path;
            $("#gallaryPreview"+id).css("height", "100px");
            $('#gallaryPreview'+id).attr('src',imgpath);
            $('#GallaryPath'+id).val(imgpath);

            var i = 0;
            if (i == 0) {
                i = 1;
                var elem = document.getElementById("myBarbulk");
                var width = 1;
